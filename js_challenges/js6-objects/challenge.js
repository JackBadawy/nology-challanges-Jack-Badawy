...
export const makeSpaceship = (
  ...
  let newObj = {};
  newObj["name"] = name;
  newObj["noOfSeats"] = noOfSeats;
  newObj["engineType"] = engineType;
  newObj["canTravelSolarSystems"] = canTravelSolarSystems;
  return newObj;
};
...
export const setSafeAllergens = (customer, allergenList) => ({
  ...customer,
  safeAllergens: allergenList.filter(
...
export const mergeFurniture = (furnitureLocationData, furnitureProductData) => {
  /* Write code here */
  let product = {};
  product["id"] = furnitureProductData.id; //up  to here
  product["location"] = furnitureLocationData.location;
  product["sku"] = furnitureLocationData.sku;
  product["name"] = furnitureProductData.name;
  product["price"] = furnitureProductData.price;
  product["isAvailable"] = furnitureProductData.isAvailable;
